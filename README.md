...
1. Осторожнее с вакансиями, у которых названия должности и организации в трекере неточно совпадают с таковыми на hh: программа подумает, что это разные, и зальёт второй раз. Можно сделать потом умный поиск.
2. Пытаться залить некий список вакансий в трекер второй раз не рекомендуется: поскольку парсер не ищет по столбцу с отказами и приглашениями на собеседование, могут быть повторы.
3. Часовой пояс GMT+3, выставлен в utils.
